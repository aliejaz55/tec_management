...
{
    /** Url path */
    const SEGMENT_URL_PATH_EDIT = 'tecfeature/segment/edit';
    const SEGMENT_URL_PATH_DELETE = 'tecfeature/segment/delete';
    ...
    public function __construct(
        ...
        array $components = [],
        array $data = [],
        $editUrl = self::SEGMENT_URL_PATH_EDIT
    ) {
